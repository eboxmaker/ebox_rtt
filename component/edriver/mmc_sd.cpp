...
#define sdDebug(...)  rt_kprintf("[sd]:%d: ",__LINE__),rt_kprintf(__VA_ARGS__ )
#else
#define sdDebug(...)
#endif
...
{
    uint64_t cap = _block_size * _sectors;
    return cap;
}
