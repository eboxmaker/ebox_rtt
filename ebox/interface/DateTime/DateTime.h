...
public:
    ...
    DateTime(int y,int mon,int d,int h,int m,int s ,int utc_offset = LOCAL_UTC_OFFSET);
    bool parse(uint64_t stamp);
    bool parse(String str);
    bool parse(String date,String time,int utc_offset = LOCAL_UTC_OFFSET);
    bool parse(int y,int mon,int d,int h,int m,int s ,int utc_offset = LOCAL_UTC_OFFSET);
    bool isLeapYear();
