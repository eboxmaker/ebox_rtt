...
#define LFS_INFO(fmt, ...)  rt_kprintf("lfs info:%d: " fmt "\n", __LINE__, __VA_ARGS__)
...
#define LFS_DEBUG(fmt, ...) rt_kprintf("lfs debug:%d: " fmt "\n", __LINE__, __VA_ARGS__)
...
#define LFS_WARN(fmt, ...)  rt_kprintf("lfs warn:%d: " fmt "\n", __LINE__, __VA_ARGS__)
...
#define LFS_ERROR(fmt, ...) rt_kprintf("lfs error:%d: " fmt "\n", __LINE__, __VA_ARGS__)
